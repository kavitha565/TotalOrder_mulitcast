...
public static boolean checkAcknowledgement(Event event){
	...
	public static void main(String[] args) {
		Process2 totalOrder = new Process2();
		totalOrder.init();

		try {
			if(Process2.createConnectionsThread != null){
				Process2.createConnectionsThread.join();
			}
			if(Process2.orderedDeliveryThread != null){
				Process2.orderedDeliveryThread.join();
			}
			if(Process2.eventAcknowledgementThread != null){
				Process2.eventAcknowledgementThread.join();
			}
		...
		System.out.println("Process "+Process2.processId+" ended!");
